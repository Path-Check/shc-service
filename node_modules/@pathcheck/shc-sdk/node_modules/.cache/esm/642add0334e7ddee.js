let jose,JWK,pako,base64url,getKeyId;_34e‍.x([["makeJWT",()=>makeJWT],["parseJWT",()=>parseJWT],["sign",()=>sign],["verify",()=>verify],["unpack",()=>unpack],["pack",()=>pack],["unpackAndVerify",()=>unpackAndVerify],["signAndPack",()=>signAndPack]]);_34e‍.w("node-jose",[["default",["jose"],function(v){jose=v}],["JWK",["JWK"],function(v){JWK=v}]]);_34e‍.w("pako",[["default",["pako"],function(v){pako=v}]]);_34e‍.w("base64url",[["default",["base64url"],function(v){base64url=v}]]);_34e‍.w("./resolver",[["getKeyId",["getKeyId"],function(v){getKeyId=v}]]);
 ...
 */
       async function makeJWT(payload, monthsToExpire, issuer) {
  let iss = new Date();
...
async function verifyAndReturnPayload(jws, signingKey) {
  ...
  return JSON.parse(body.toString());
       ...
       async function verify(jws, pubkeyKey) {
  try {
    await verifyAndReturnPayload(jws, pubkeyKey);
    return true;
  } catch (err) {
    _34e‍.g.console.log(err);
    return false;
  }
}
